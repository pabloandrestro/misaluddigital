...
class MedicalProfile(models.Model):
    ...
    relevant_clinical_information = models.TextField(blank=True, default= "")
    current_medications    = models.JSONField(blank=True, default=list)
    recent_medical_history = models.JSONField(blank=True, default=list)
    relevance_type         = models.JSONField(blank=True, default=list)
